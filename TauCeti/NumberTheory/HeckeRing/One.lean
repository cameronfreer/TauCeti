...
[#41279](https://github.com/leanprover-community/mathlib4/pull/41279) (Chris Birkbeck), per the
...
diagonal. -/
lemma multiplicity_one_left_eq_zero [IsHeckeTriple Δ H₁ H₁]
    (g : Δ) {A : HeckeCoset Δ H₁ H₂} (hA : A ≠ HeckeCoset.mk H₁ H₂ g) :
